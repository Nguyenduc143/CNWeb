        ...
        <div className="container">
          <div className="footer-grid">
            ...
            <div className="footer-col footer-about">
              <h3 className="footer-logo-text">📱 CỬA HÀNG DI ĐỘNG</h3>
              <p>
              ...
              <div className="footer-contact">
                <p>📞 Hotline: <strong>1800 6868</strong></p>
                <p>📍 94 Thái Hà, Đống Đa, Hà Nội</p>
                <p>📍 398 Cầu Giấy, Cầu Giấy, Hà Nội</p>
                <p>✉️ info@cuahangdidong.vn</p>
              </div>
            </div>
